...
<body text="#000000" bgcolor="#FFFFFF" link="#0000FF" vlink="#800080" alink="#FF0000">
  ...
  <h1>Coordination of debian-l10n-<?php echo $language; ?></h1>
  ...
  <table>
    <tr>
      <th></th>
      <th><a href='<?=$PHP_SELF?>?sort=name'>Name</a></th>
      <th><a href='<?=$PHP_SELF?>?sort=translator'>Translator</a></th>
      <th><a href='<?=$PHP_SELF?>?sort=status'>Status</a></th>
      <th><a href='<?=$PHP_SELF?>?sort=date'>Date</a></th>
      <th>File</th>
      <th></th>
    </tr>
<?
...
?>
  ...
  <p>
    <small>
      Comments: <a href='mailto:<?php echo $webmaster ?>'>webmaster</a>
    </small>
  </p>
</body>
</html>
